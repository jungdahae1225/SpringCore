...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("특정 하위 타입으로 조회") //=> 안좋은 방법이니 최대한 지양.
    ...
    static class TestConfig {
        /**
         * 메서드 타입과 이름을 정할 때는
         * DiscountPolicy"추상체" rateDiscountPolicy"구현체" 이런 방식으로 짜는 것이 좋다.
         * RateDiscountPolicy rateDiscountPolicy() 이런 식의 이름은 좋은 방법이 아니다.
         * */
        @Bean
